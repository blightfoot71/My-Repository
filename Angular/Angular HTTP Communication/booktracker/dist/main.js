...
var CacheInterceptor = /** @class */ (function () {
    ...
    CacheInterceptor.prototype.intercept = function (req, next) {
        ...
        // If we get here, we know we are dealing with a GET request
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.handleHttpError = function (error) {
        ...
        dataError.friendlyMessage = 'An error occurred retrieing data.';
    ...
    DataService.prototype.getOldBookById = function (id) {
        ...
        }); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (classBook) { return console.log(classBook); }));
    };
...
var allReaders = [
    ...
    { readerID: 4, name: 'Fake', weeklyReadingGoal: -1, totalMinutesRead: -2 }
];
var allBooks = [
...
module.exports = __webpack_require__(/*! C:\Users\Brian\source\repos\Angular\Angular HTTP Communication\booktracker\src\main.ts */"./src/main.ts");
